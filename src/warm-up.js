...
// 'We need to get some more [food].'
  if (inStock >= 1) {
    ...
    console.log(`I'm going to get some more ${food}`);
  };
...
var vegetables = ["carrots", "green beans", "cabbage", "corn", "peppers"];
...
// different fruits.
var fruits = ["apples", "kiwi", "blackberry", "banana", "peach", "mango", "lychee"];
